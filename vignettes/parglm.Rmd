...
single threaded performance of `parglm` may be slower when there are more coefficients. 
The cause seems to be the difference between the LAPACK and LINPACK implementation. 
This can either be due to QR decomposition method or the `qr.qty` method. 
